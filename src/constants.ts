...
const EXPO_PUBLIC_APP_CHANNEL = (process.env as Record<string, string | undefined>)
  .EXPO_PUBLIC_APP_CHANNEL;
const EXPO_PUBLIC_ORGANIZER_TEST_MODE = (process.env as Record<string, string | undefined>)
  .EXPO_PUBLIC_ORGANIZER_TEST_MODE;
const EXPO_PUBLIC_ORGANIZER_SECURITY_ENFORCED =
  (process.env as Record<string, string | undefined>).EXPO_PUBLIC_ORGANIZER_SECURITY_ENFORCED;
const EXPO_PUBLIC_PARTICIPANT_SECURITY_ENFORCED =
  (process.env as Record<string, string | undefined>).EXPO_PUBLIC_PARTICIPANT_SECURITY_ENFORCED;
const EXPO_PUBLIC_DEMO_ALL_OPEN = (process.env as Record<string, string | undefined>)
  .EXPO_PUBLIC_DEMO_ALL_OPEN;
const EXPO_PUBLIC_ADMOB_ENABLED = (process.env as Record<string, string | undefined>)
  .EXPO_PUBLIC_ADMOB_ENABLED;
const EXPO_PUBLIC_ADMOB_TEST_MODE = (process.env as Record<string, string | undefined>)
  .EXPO_PUBLIC_ADMOB_TEST_MODE;
const EXPO_PUBLIC_PAID_FEATURE_UNLOCK_CONTACT =
  (process.env as Record<string, string | undefined>).EXPO_PUBLIC_PAID_FEATURE_UNLOCK_CONTACT;
const EXPO_PUBLIC_ADMIN_CONTACT_EMAIL = (process.env as Record<string, string | undefined>)
  .EXPO_PUBLIC_ADMIN_CONTACT_EMAIL;
const EXPO_PUBLIC_EMAIL_WEBHOOK_URL = (process.env as Record<string, string | undefined>)
  .EXPO_PUBLIC_EMAIL_WEBHOOK_URL;
const EXPO_PUBLIC_ORGANIZER_COMPLIANCE_WEBHOOK_URL =
  (process.env as Record<string, string | undefined>).EXPO_PUBLIC_ORGANIZER_COMPLIANCE_WEBHOOK_URL;
const EXPO_PUBLIC_EVENT_WEB_BASE_URL = (process.env as Record<string, string | undefined>)
  .EXPO_PUBLIC_EVENT_WEB_BASE_URL;
const EXPO_PUBLIC_PRIVACY_POLICY_URL = (process.env as Record<string, string | undefined>)
  .EXPO_PUBLIC_PRIVACY_POLICY_URL;
const EXPO_PUBLIC_SUPABASE_URL = (process.env as Record<string, string | undefined>)
  .EXPO_PUBLIC_SUPABASE_URL;
const EXPO_PUBLIC_SUPABASE_ANON_KEY = (process.env as Record<string, string | undefined>)
  .EXPO_PUBLIC_SUPABASE_ANON_KEY;
const EXPO_PUBLIC_SPONSOR_CHECKOUT_URL = (process.env as Record<string, string | undefined>)
  .EXPO_PUBLIC_SPONSOR_CHECKOUT_URL;
const EXPO_PUBLIC_SPONSOR_MODULE_CHECKOUT_URL =
  (process.env as Record<string, string | undefined>).EXPO_PUBLIC_SPONSOR_MODULE_CHECKOUT_URL;
const EXPO_PUBLIC_STRIPE_CONNECT_URL = (process.env as Record<string, string | undefined>)
  .EXPO_PUBLIC_STRIPE_CONNECT_URL;
const EXPO_PUBLIC_STRIPE_CONNECT_SYNC_URL =
  (process.env as Record<string, string | undefined>).EXPO_PUBLIC_STRIPE_CONNECT_SYNC_URL;
const EXPO_PUBLIC_PARTICIPANT_CHECKOUT_URL =
  (process.env as Record<string, string | undefined>).EXPO_PUBLIC_PARTICIPANT_CHECKOUT_URL;
const EXPO_PUBLIC_ADMOB_BANNER_UNIT_ID_ANDROID =
  (process.env as Record<string, string | undefined>).EXPO_PUBLIC_ADMOB_BANNER_UNIT_ID_ANDROID;
const EXPO_PUBLIC_ADMOB_BANNER_UNIT_ID_IOS =
  (process.env as Record<string, string | undefined>).EXPO_PUBLIC_ADMOB_BANNER_UNIT_ID_IOS;
const EXPO_PUBLIC_ADMOB_INTERSTITIAL_UNIT_ID_ANDROID =
  (process.env as Record<string, string | undefined>)
    .EXPO_PUBLIC_ADMOB_INTERSTITIAL_UNIT_ID_ANDROID;
const EXPO_PUBLIC_ADMOB_INTERSTITIAL_UNIT_ID_IOS =
  (process.env as Record<string, string | undefined>)
    .EXPO_PUBLIC_ADMOB_INTERSTITIAL_UNIT_ID_IOS;

export const APP_CHANNEL: 'demo' | 'prod' =
  String(EXPO_PUBLIC_APP_CHANNEL ?? '').trim().toLowerCase() === 'demo'
    ? 'demo'
    : 'prod';
export const IS_DEMO_CHANNEL = APP_CHANNEL === 'demo';

const organizerTestModeFromEnv = parseEnvBoolean(EXPO_PUBLIC_ORGANIZER_TEST_MODE);
...
export const EMAIL_WEBHOOK_URL = EXPO_PUBLIC_EMAIL_WEBHOOK_URL;
export const ORGANIZER_COMPLIANCE_WEBHOOK_URL =
  EXPO_PUBLIC_ORGANIZER_COMPLIANCE_WEBHOOK_URL;
export const EVENT_WEB_BASE_URL = EXPO_PUBLIC_EVENT_WEB_BASE_URL;
export const PRIVACY_POLICY_URL =
  EXPO_PUBLIC_PRIVACY_POLICY_URL || EVENT_WEB_BASE_URL;
export const SUPABASE_URL = EXPO_PUBLIC_SUPABASE_URL;
export const SUPABASE_ANON_KEY = EXPO_PUBLIC_SUPABASE_ANON_KEY;
export const SPONSOR_CHECKOUT_URL = EXPO_PUBLIC_SPONSOR_CHECKOUT_URL;
export const SPONSOR_MODULE_CHECKOUT_URL =
  EXPO_PUBLIC_SPONSOR_MODULE_CHECKOUT_URL;
export const STRIPE_CONNECT_URL = EXPO_PUBLIC_STRIPE_CONNECT_URL;
export const STRIPE_CONNECT_SYNC_URL = EXPO_PUBLIC_STRIPE_CONNECT_SYNC_URL;
export const PARTICIPANT_CHECKOUT_URL = EXPO_PUBLIC_PARTICIPANT_CHECKOUT_URL;
